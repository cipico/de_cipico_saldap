...
"""
        ...
        try {
          ...
          sh "docker exec saldap-app-${BUILD_NUMBER} test -f ${ciSettings} || docker exec saldap-app-${BUILD_NUMBER} sh -c 'find /buildkit/build/${buildName} -name civicrm.settings.php 2>/dev/null'"
